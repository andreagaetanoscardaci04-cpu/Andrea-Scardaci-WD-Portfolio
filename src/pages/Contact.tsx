          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            <div className="order-2 lg:order-1 bg-white p-6 sm:p-10 md:p-12 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl border border-brand-dark/[0.06]">
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="text-3xl font-bold mb-4 text-brand-dark">Grazie!</h3>
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-xs font-medium text-brand-dark/70 uppercase tracking-widest">Nome Completo</label>
                    <input
                      required
                      type="text"
                      name="from_name"
            ...
            <div className="order-1 lg:order-2 space-y-12">
              ...
              <div className="p-8 bg-emerald-50 rounded-3xl border border-emerald-100">
                ...
                <p className="text-emerald-800/70 font-light mb-6">
                ...
                <a
                  ...
                  className="inline-flex items-center bg-emerald-600 text-white px-8 py-3 rounded-full font-medium hover:bg-emerald-700 transition-all"
                >
