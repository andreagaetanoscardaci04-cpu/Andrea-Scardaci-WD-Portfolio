...
const PrivacyPolicy = () => {
  return (
    <div className="pt-32 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="#privacy-policy"
                className="inline-flex items-center gap-2 bg-white text-brand-dark px-6 py-3 rounded-full font-medium text-sm hover:bg-brand-accent hover:text-white transition-colors"
              >
              ...
              <Link
                to="#cookie-policy"
                className="inline-flex items-center gap-2 border border-white/20 text-white px-6 py-3 rounded-full font-medium text-sm hover:border-brand-accent hover:text-brand-accent transition-colors"
              >
      ...
      {/* ── PRIVACY POLICY ───────────────────────────── */}
      <section id="privacy-policy" data-animated-bg-region className="section-padding scroll-mt-28 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-white">Privacy Policy</h2>

            <div className="space-y-8 text-white/60 font-light leading-relaxed">
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Titolare del trattamento</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Quali dati raccogliamo</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Finalità del trattamento</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Base giuridica</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Conservazione dei dati</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Comunicazione dei dati a terzi</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Diritti dell'interessato</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Modifiche alla presente informativa</h3>
                <p>
      ...
      {/* ── COOKIE POLICY ────────────────────────────── */}
      <section id="cookie-policy" data-animated-bg-region className="section-padding scroll-mt-28 relative overflow-hidden">
        <div className="absolute inset-0 bg-black/55 pointer-events-none" />
        <div className="container-custom relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-8 text-white">Cookie Policy</h2>

            <div className="space-y-8 text-white/60 font-light leading-relaxed">
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Cosa sono i cookie</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Cookie utilizzati da questo sito</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Come gestire i cookie dal browser</h3>
                <p>
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">Aggiornamenti futuri</h3>
                <p>
